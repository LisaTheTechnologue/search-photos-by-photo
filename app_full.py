...
def get_image_embeddings(img):
    try:
        ...
        embs = DeepFace.represent("temp.jpg", enforce_detection=False)
...
def main():
    ...
    if uploaded_file is None:
        ...
        with st.expander('Source Images'):
            imgs = read_zip_file(uploaded_file)
        ...
        with tab2:
            ...
            src_embs = [get_image_embeddings(np.array(i)) for i in imgs if get_image_embeddings(np.array(i)) is not None]
            text_search(imgs,src_embs)
